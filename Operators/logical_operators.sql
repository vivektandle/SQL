...
select ename, deptno ,job from employee where job='CLERK' and (deptno=10 or deptno=20);
...
select employee.* , sal*12 as annual_salary from employee where sal>1000 and sal<4000 and annual_salary >15000;